...
#define K int(1e5)
#define X 4 //kinds of participate medium
...
int main()
{
    ...
    a[1] = { 1,"pericarp",83, 100e2, 0.85 ,1.333 };
    a[2] = { 2,"pulp",    40, 100e2, 0.85 ,1.333 };
    a[3] = { 3,"kernel",  40, 100e2,0.85,1.333 };
    ...
    std::string directory0 = "C:\\Users\\Administrator\\source\\data\\model_kiwinoskinskin.dat";
    std::string directory1 = "C:\\Users\\Administrator\\source\\data\\path_kiwi_noskinskin.dat";
